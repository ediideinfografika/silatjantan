(function($, Drupal, drupalSettings) {
  ...
  Drupal.Leaflet.prototype.create_point = function(marker) {
    ...
    var theString=self.mapid;
    if (theString.indexOf('penutupan') !== -1) {
 
    var myIcon = L.icon({
      iconUrl: 'https://silatjantan.dpupr.madiunkab.go.id/sites/default/files/stop-sign.png',
      iconSize: [40, 45], // size of the icon
      });

    lMarker = new L.Marker(latLng, {icon: myIcon});
    }
    else{
